...
function exp_Passagespitons_1rule0_eval_expression(context) {
    // crossing IS 'unmarked'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('crossing')  === 'unmarked');
    } else {
        return (feature.get('crossing')  === 'unmarked');
    }
}
...
function exp_Passagespitons_1rule1_eval_expression(context) {
    // crossing  IN ('marked', 'uncontrolled') OR "crossing:markings"  IN ('zebra', 'pictograms')

    var feature = context.feature;
    
    if (feature.properties) {
        return ("'marked', 'uncontrolled'".indexOf(feature.get('crossing') ) > -1  || "'zebra', 'pictograms'".indexOf(feature.get('crossing:markings') ) > -1 );
    } else {
        return ("'marked', 'uncontrolled'".indexOf(feature.get('crossing') ) > -1  || "'zebra', 'pictograms'".indexOf(feature.get('crossing:markings') ) > -1 );
    }
}